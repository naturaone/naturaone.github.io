...
如對此藍圖志同道合，請移步至技術實現倉庫，一同將藍圖實現：https://github.com/naturaone/Deus-Fabrica

## 授權聲明

本倉庫所有內容（包括但不限於：思想文章、方案設計、頁面佈局、Logo）採用 **創用CC 姓名標示-非商業性-禁止改作 4.0 國際授權條款 (CC BY-NC-ND 4.0)**。
